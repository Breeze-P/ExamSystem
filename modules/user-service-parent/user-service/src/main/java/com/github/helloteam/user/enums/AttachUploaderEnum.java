package com.github.helloteam.user.enums;
...
public enum AttachUploaderEnum {
     ...
     * 文件
     */
    FILE(1, "文件", "com.github.helloteam.user.uploader.FileUploader"),

    /**
     * Fast DFS
     */
    FAST_DFS(2, "FastDfs", "com.github.helloteam.user.uploader.FastDfsUploader"),

    /**
     * 七牛云
     */
    QI_NIU(3, "七牛云", "com.github.helloteam.user.uploader.QiNiuUploader");
